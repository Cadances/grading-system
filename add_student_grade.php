			...
			<tr>
				<th>
					<table width="100%" cellspacing="0">
						...
						<tr>
							<th width=25%" style="background-color: #f38b5a;border-bottom: 1px solid;padding: 5px 0px;">Hình ảnh</th>
							<th width="25%" style="background-color: #f38b5a;border-bottom: 1px solid;padding: 5px 0px;">Tên</th>
							<th width="25%" style="background-color: #f38b5a;border-bottom: 1px solid;padding: 5px 0px;">Điểm</th>
							<th width="25%" style="background-color: #f38b5a;border-bottom: 1px solid;padding: 5px 0px;">
								<a href="choose_grading.php" style="text-decoration: none;padding: 0px 15px;color: black;background-color: #abb5fb;border: 2px solid black;border-style: outset;border-radius: 5px;">Trang trước</a>
							</th>
						</tr>
						<?php
