			...
			<tr>
				<td>
					...
					<table style="border: 4px solid #0909da;border-style: inset;border-radius: 10px;background-color: #c9e8ec;">
						<tr>
							<th style="border-bottom: 2px solid;padding: 5px 0px;">Tạo tài khoản giáo viên mới</th>
						</tr>
						<tr>
							<th width="50%" style="border-bottom: 2px solid;">
								<table width="100%">
									...
									<tr>
										<th style="text-align: left;padding-left: 20px;">Tên người dùng: </th>
										<td><input type="text" name="username" value="<?php echo '';?>" required></td>
									</tr>
									<tr>
										<th style="text-align: left;padding-left: 20px;">Mật khẩu: </th>
										<td><input type="password" name="password" value="<?php echo '';?>" required></td>
									</tr>
									<tr>
										<th style="text-align: left;padding-left: 20px;">Hình ảnh: </th>
										<td><input type="file" name="image" id="image" value="<?php echo '';?>" style="width: 73%;"></td>
									</tr>
								</table>
							</th>
						<tr>
